    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_number_1', models.PositiveBigIntegerField(verbose_name='Número Predial Nacional 1/3')),
                ('national_number_2', models.PositiveBigIntegerField(verbose_name='Número Predial Naciona 2/3')),
                ('national_number_3', models.PositiveBigIntegerField(verbose_name='Número Predial Nacional 3/3')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estates_appraisals', related_query_name='estate_appraisal', to='properties.estate', verbose_name='Avaluo Predio')),
                ('state_change_user', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
