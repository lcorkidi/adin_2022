...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Estate',
            fields=[
                ('national_number', models.PositiveIntegerField(verbose_name='Número Predial Nacional')),
                ...
                ('appraisal', models.ManyToManyField(related_name='estates', related_query_name='estate', to='references.Appraisal', verbose_name='Avaluo(s)')),
            ],
            options={
                'verbose_name': 'Predio',
