    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('activate_account', 'Can activate account.'), ('check_account', 'Can check account.'), ('view_balance', 'Can view balance.')],
            },
        ),
        migrations.CreateModel(
            name='Ledger_Type',
            ...
            options={
                ...
                'permissions': [('activate_ledger_type', 'Can activate ledger type.'), ('check_ledger_type', 'Can check ledger type.')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('state_change_date', models.DateTimeField(auto_now=True)),
                ('state', models.PositiveSmallIntegerField(choices=[(0, 'Inactivo'), (1, 'Por Correguir'), (2, 'Por Revisar'), (3, 'Revisado')], default=1)),
                ('code', models.CharField(max_length=128, primary_key=True, serialize=False, verbose_name='Nombre')),
                ...
                ('state_change_user', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('transaction_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ledgers_templates', related_query_name='ledger_template', to='accountables.transaction_type', verbose_name='Tipo Transacción')),
            ],
            options={
