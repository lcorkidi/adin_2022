...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('role', 1)), fields=('person',), name='unique_lesee'),
        ),
        migrations.AddConstraint(
            model_name='lease_realty_person',
            constraint=models.UniqueConstraint(condition=models.Q(('role', 3)), fields=('person',), name='unique_titular_lessor'),
        ),
    ]
