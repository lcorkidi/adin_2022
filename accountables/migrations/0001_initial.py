    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_types', models.ManyToManyField(related_name='accountables', related_query_name='accountable', to='references.Transaction_Type', verbose_name='Tipos de Cargo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('activate_lease_realty', 'Can activate lease realty.'), ('accounting_lease_realty', 'Can do lease realty accounting.')],
            },
