    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controlled_value', models.BooleanField(verbose_name='Valor Supeditato')),
                ('relation_dependant', models.BooleanField(verbose_name='Dependiente de Documento')),
                ('state_change_user', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Transacción Tipo',
                'verbose_name_plural': 'Transacciones Tipos',
                'permissions': [('activate_accountable_transaction_type', 'Can activate transaction type.'), ('check_accountable_transaction_type', 'Can check transaction type.')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_relation', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='accountable_concept', related_query_name='accountable_concepts', to='accountables.date_value', verbose_name='Fecha Valor')),
            ],
            options={
