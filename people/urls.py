...
urlpatterns = [
    ...
    path('<int:pk>/update_phone/', views.People_PhoneUpdateView.as_view(), name='people_phone_update'),
    path('<int:pk>/update_email/', views.People_EmailUpdateView.as_view(), name='people_email_update'),
    path('<int:pk>/update_address/', views.People_AddressUpdateView.as_view(), name='people_address_update'),
