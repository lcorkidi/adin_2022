    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.PositiveSmallIntegerField(choices=[(0, 'Inactivo'), (1, 'Por Revisar'), (2, 'Por Correguir'), (3, 'Revisado')], default=1, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_change_user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('person', 'phone'), name='unique_person_phone'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('person', 'email'), name='unique_person_email'),
        ),
        migrations.AddConstraint(
            model_name='person_address',
            constraint=models.UniqueConstraint(fields=('person', 'address'), name='unique_person_address'),
        ),
        migrations.AddConstraint(
            model_name='person_legal_person_natural',
